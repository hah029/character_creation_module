...
def attack(char_name: str, char_class: str) -> str:
    """Определяет и выводит в консоль количество нанесенного урона"""
...
def defence(char_name: str, char_class: str) -> str:
    """Определяет и выводит в консоль количество заблокированного урона"""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Определяет и выводит в консоль показатели специального умения"""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Выводит в консоль правила игры в виде тренировки"""
    if char_class == 'warrior':
